...
async function translateBatch(lines, convert) {
    const parsed = await convert({
        system: SYSTEM_PROMPT,
        user: 'Translate these lyric lines to English. Return one output line per input line.\n\n' +
...
async function toEnglish(cues, convert) {
