...
exports.buildWordTimings = buildWordTimings;
exports.lineDurationMs = lineDurationMs;
exports.lineEnergy = lineEnergy;
exports.findCueIndex = findCueIndex;
...
function lineDurationMs(cues, index) {
...
function lineEnergy(cues, index) {
    const cue = cues[index];
    if (!cue)
        return 0;
